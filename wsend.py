...
def send_msg(name_excel_file, name_img, index):
    """
    ...
    index_of_name = index
    msg = read_txt_file()
    excel_data = pd.read_excel(f'C:\\whatsend\\media\\{name_excel_file}.xlsx')  # Открываем файл

    img = f'C:\\whatsend\\media\\{name_img}.jpeg'  # Путь к картинке
